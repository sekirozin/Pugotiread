...
function renderLibraryButton(library) {
...
function renderVaultContextMenu() {
    return `
...
export function renderLibraryContextMenu(library) {
    return `
...
function renderServerSectionButton(section, label) {
